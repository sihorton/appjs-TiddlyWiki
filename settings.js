var fs           = require('fs'),
    path         = require('path'),
	os			 = require('os'),		/* AppJS-TiddlyWiki Added */
    decorate     = require('./utils').decorate,
    constants    = require('./utils').constants,
    platformPath = require('./bindings').platformPath;

/* AppJS-TiddlyWiki Added */
var twString = "AppJsTw/1.0";
var osString = '';
switch (os.platform()) {
	case "win32":
		osString = "Windows NT 6.1";
		break;
	case "darwin":
		osString = "Macintosh; Intel Mac OS X 10_7_5";
		break;
	default:
		osString = "Linux; X11";
		break;
}
/* End AppJS-TiddlyWiki Added */
...
decorate(AppSettings.prototype, {
  ...
  /* AppJS-TiddlyWiki Modified - was "UserAgent : ''," */
  UserAgent              : "Mozilla/5.0 (" + osString + ") AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.0 Safari/537.1 " + twString,
  ProductVersion         : '',
  Locale                 : '',
